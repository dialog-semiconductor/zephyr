...
#define RRH46410_WAIT_TIME_20                         20
#define RRH46410_WAIT_TIME_50                         50
#define RRH46410_WAIT_TIME_200                        200
...
#define RRH46410_OPERATION_MODE_SUSPEND               0x00
#define RRH46410_OPERATION_MODE_IAQ_2ND_GEN           0x01
#define RRH46410_OPERATION_MODE_IAQ_2ND_GEN_ULP       0x02
#define RRH46410_OPERATION_MODE_PBAQ                  0x05

/* Definitions of data position */
#define RRH46410_POSITION_ERROR_CODE                  0
#define RRH46410_POSITION_SAMPLE_ID                   1

/* Definitions of encoded humidity */
#define RRH46410_ENCODED_HUMIDITY(humidity_float)    (uint8_t) ((humidity_float / 100.0F) * 255.0F) // float -> uint8_t
