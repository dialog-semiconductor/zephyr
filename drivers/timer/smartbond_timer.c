...
#define TICK_TO_CYC(tick) ((tick) * sys_clock_hw_cycles_per_sec() / CONFIG_SYS_CLOCK_TICKS_PER_SEC)
#define CYC_TO_TICK(cyc) ((cyc) * CONFIG_SYS_CLOCK_TICKS_PER_SEC / sys_clock_hw_cycles_per_sec())
